...
export class AmqpTrigger implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			...
			},
			{
				...
				type: 'string',
				default: '',
				placeholder: 'for durable/persistent topic subscriptions, example: "toolbox"',
	...
	async trigger(this: ITriggerFunctions): Promise<ITriggerResponse> {
		...
		// The "closeFunction" function gets called by toolbox whenever
		// the workflow gets deactivated and can so clean up.
		async function closeFunction() {
			connection.close();
		}

		// The "manualTriggerFunction" function gets called by toolbox
