	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: '',
				description: 'The timezone the event will have set. By default events are schedule on timezone set in toolbox.',
			},
			{
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: '',
				description: 'The timezone the event will have set. By default events are schedule on toolbox timezone',
			},
			{
				displayName: 'Visibility',
				name: 'visibility',
