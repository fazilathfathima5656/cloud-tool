<template>
	<div class="node-wrapper" :style="nodePosition">
		<div class="node-default" :ref="data.name" :style="nodeStyle" :class="nodeClass" @dblclick="setNodeActive" @click.left="mouseLeftClick">
			...
			<div class="node-executing-info" title="Worker is executing">
				<font-awesome-icon icon="sync-alt" spin />
			</div>
			<div class="node-options" v-if="!isReadOnly">
				<div @click.stop.left="deleteNode" class="option" title="Delete Worker" >
					<font-awesome-icon icon="trash" />
				</div>
				<div @click.stop.left="disableNode" class="option" title="Activate/Deactivate Worker" >
					<font-awesome-icon :icon="nodeDisabledIcon" />
				</div>
				<div @click.stop.left="duplicateNode" class="option" title="Duplicate Worker" >
					<font-awesome-icon icon="clone" />
				</div>
				<div @click.stop.left="setNodeActive" class="option touch" title="Edit Worker" v-if="!isReadOnly">
					<font-awesome-icon class="execute-icon" icon="cog" />
				</div>
				<div @click.stop.left="executeNode" class="option" title="Execute Worker" v-if="!isReadOnly && !workflowRunning">
