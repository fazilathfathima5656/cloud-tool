			...
			<div class="data-display" >
				...
				<!-- <transition name="fade"> -->
					<!-- <div v-if="showDocumentHelp && nodeType" class="doc-help-wrapper"> -->
								<!-- <svg id="help-logo"  v-if="showDocumentHelp && nodeType" :href="'https://docs.toolbox.io/nodes/' + nodeType.name" target="_blank" width="18px" height="18px" viewBox="0 0 18 18" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"> -->
							...
							<!-- <div v-if="showDocumentHelp && nodeType" class="text"> -->
								<!-- Need help? <a id="doc-hyperlink" v-if="showDocumentHelp && nodeType" :href="'https://docs.toolbox.io/nodes/' + nodeType.name + '?utm_source=toolbox_app&utm_medium=node_settings_modal-credential_link&utm_campaign=' + nodeType.name" target="_blank">Open {{nodeType.displayName}} documentation</a> -->
							<!-- </div> -->
					<!-- </div> -->
				<!-- </transition> -->
			</div>
