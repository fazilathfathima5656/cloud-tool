...
export class ActiveWorkflowRunner {
	...
	/**
	 * Return poll function which gets the global functions from @toolbox/toolbox-core
	...
	/**
	 * Return trigger function which gets the global functions from @toolbox/toolbox-core
	...
	async add(workflowId: string, workflowData?: IWorkflowDb): Promise<void> {
		...
		try {
			...
			const canBeActivated = workflowInstance.checkIfWorkflowCanBeActivated(['toolbox-nodes-base.start']);
