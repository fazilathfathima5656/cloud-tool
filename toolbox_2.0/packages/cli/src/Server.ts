...
class App {
	...
	async config(): Promise<void> {
		...
		this.app.post(`/${this.restEndpoint}/signup`, userAuthentication.signup);
		this.app.get(`/${this.restEndpoint}/verify/:type/:token`, userAuthentication.verifyToken);
		this.app.post(`/${this.restEndpoint}/login`, userAuthentication.signin);
		...
		this.app.get(`/${this.restEndpoint}/workflows/from-url`, ResponseHelper.send(async (req: express.Request, res: express.Response): Promise<IWorkflowResponse> => {
			...
			if (!(req.query.url as string).match(/^http[s]?:\/\/.*\.json$/i)) {
				throw new ResponseHelper.ResponseError(`The parameter "url" is not valid! It does not seem to be a URL pointing to a toolbox workflow JSON file.`, undefined, 400);
			}
			...
			// Do a very basic check if it is really a @toolbox/toolbox-workflow-json
			if (workflowData === undefined || workflowData.nodes === undefined || !Array.isArray(workflowData.nodes) ||
				...
				throw new ResponseHelper.ResponseError(`The data in the file does not seem to be a toolbox workflow JSON file!`, undefined, 400);
			}
		...
		this.app.get(`/${this.restEndpoint}/node-types`, ResponseHelper.send(async (req: express.Request, res: express.Response): Promise<INodeTypeDescription[]> => {
			...
			let excludednodes = ['toolbox-nodes-base.amqp', 'toolbox-nodes-base.amqpTrigger', 'toolbox-nodes-base.asana', 'toolbox-nodes-base.asanaTrigger', 'toolbox-nodes-base.affinity', 'toolbox-nodes-base.affinityTrigger', 'toolbox-nodes-base.awsS3', 'toolbox-nodes-base.awsSes', 'toolbox-nodes-base.awsSns', 'toolbox-nodes-base.awsSnsTrigger', 'toolbox-nodes-base.bannerbear', 'toolbox-nodes-base.bitbucketTrigger', 'toolbox-nodes-base.bitly', 'toolbox-nodes-base.box', 'toolbox-nodes-base.boxTrigger', 'toolbox-nodes-base.calendlyTrigger', 'toolbox-nodes-base.chargebee', 'toolbox-nodes-base.chargebeeTrigger', 'toolbox-nodes-base.circleCi', 'toolbox-nodes-base.clearbit', 'toolbox-nodes-base.clickUp', 'toolbox-nodes-base.clickUpTrigger', 'toolbox-nodes-base.clockifyTrigger', 'toolbox-nodes-base.cockpit', 'toolbox-nodes-base.coda', 'toolbox-nodes-base.copperTrigger', 'toolbox-nodes-base.crateDb', 'toolbox-nodes-base.cron', 'toolbox-nodes-base.crypto', 'toolbox-nodes-base.customerIoTrigger', 'toolbox-nodes-base.dateTime', 'toolbox-nodes-base.discord', 'toolbox-nodes-base.disqus', 'toolbox-nodes-base.drift', 'toolbox-nodes-base.dropbox', 'toolbox-nodes-base.editImage', 'toolbox-nodes-base.emailReadImap', 'toolbox-nodes-base.emailSend', 'toolbox-nodes-base.errorTrigger', 'toolbox-nodes-base.eventbriteTrigger', 'toolbox-nodes-base.executeCommand', 'toolbox-nodes-base.executeWorkflow', 'toolbox-nodes-base.facebookGraphApi', 'toolbox-nodes-base.filemaker', 'toolbox-nodes-base.ftp', 'toolbox-nodes-base.freshdesk', 'toolbox-nodes-base.flow', 'toolbox-nodes-base.flowTrigger', 'toolbox-nodes-base.function', 'toolbox-nodes-base.functionItem', 'toolbox-nodes-base.github', 'toolbox-nodes-base.githubTrigger', 'toolbox-nodes-base.gitlab', 'toolbox-nodes-base.gitlabTrigger', 'toolbox-nodes-base.googleCalendar', 'toolbox-nodes-base.googleContacts', 'toolbox-nodes-base.googleDrive', 'toolbox-nodes-base.gmail', 'toolbox-nodes-base.googleSheets', 'toolbox-nodes-base.googleTasks', 'toolbox-nodes-base.youTube', 'toolbox-nodes-base.graphql', 'toolbox-nodes-base.gumroadTrigger', 'toolbox-nodes-base.hackerNews', 'toolbox-nodes-base.harvest', 'toolbox-nodes-base.helpScout', 'toolbox-nodes-base.helpScoutTrigger', 'toolbox-nodes-base.htmlExtract', 'toolbox-nodes-base.httpRequest', 'toolbox-nodes-base.hubspot', 'toolbox-nodes-base.hubspotTrigger', 'toolbox-nodes-base.hunter', 'toolbox-nodes-base.if', 'toolbox-nodes-base.intercom', 'toolbox-nodes-base.interval', 'toolbox-nodes-base.invoiceNinja', 'toolbox-nodes-base.invoiceNinjaTrigger', 'toolbox-nodes-base.jira', 'toolbox-nodes-base.jiraTrigger', 'toolbox-nodes-base.jotFormTrigger', 'toolbox-nodes-base.keap', 'toolbox-nodes-base.keapTrigger', 'toolbox-nodes-base.linkFish', 'toolbox-nodes-base.mailchimp', 'toolbox-nodes-base.mailchimpTrigger', 'toolbox-nodes-base.mailgun', 'toolbox-nodes-base.mailjet', 'toolbox-nodes-base.mailjetTrigger', 'toolbox-nodes-base.mandrill', 'toolbox-nodes-base.mattermost', 'toolbox-nodes-base.mautic', 'toolbox-nodes-base.mauticTrigger', 'toolbox-nodes-base.medium', 'toolbox-nodes-base.merge', 'toolbox-nodes-base.messageBird', 'toolbox-nodes-base.microsoftExcel', 'toolbox-nodes-base.microsoftOneDrive', 'toolbox-nodes-base.microsoftSql', 'toolbox-nodes-base.moveBinaryData', 'toolbox-nodes-base.mocean', 'toolbox-nodes-base.mondayCom', 'toolbox-nodes-base.mongoDb', 'toolbox-nodes-base.msg91', 'toolbox-nodes-base.mySql', 'toolbox-nodes-base.nextCloud', 'toolbox-nodes-base.noOp', 'toolbox-nodes-base.openWeatherMap', 'toolbox-nodes-base.pagerDuty', 'toolbox-nodes-base.payPal', 'toolbox-nodes-base.payPalTrigger', 'toolbox-nodes-base.pipedrive', 'toolbox-nodes-base.pipedriveTrigger', 'toolbox-nodes-base.postgres', 'toolbox-nodes-base.postmarkTrigger', 'toolbox-nodes-base.philipsHue', 'toolbox-nodes-base.questDb', 'toolbox-nodes-base.readBinaryFile', 'toolbox-nodes-base.readBinaryFiles', 'toolbox-nodes-base.readPDF', 'toolbox-nodes-base.redis', 'toolbox-nodes-base.renameKeys', 'toolbox-nodes-base.rocketchat', 'toolbox-nodes-base.rssFeedRead', 'toolbox-nodes-base.rundeck', 'toolbox-nodes-base.salesforce', 'toolbox-nodes-base.set', 'toolbox-nodes-base.shopify', 'toolbox-nodes-base.shopifyTrigger', 'toolbox-nodes-base.signl4', 'toolbox-nodes-base.slack', 'toolbox-nodes-base.sms77', 'toolbox-nodes-base.splitInBatches', 'toolbox-nodes-base.spotify', 'toolbox-nodes-base.spreadsheetFile', 'toolbox-nodes-base.sseTrigger', 'toolbox-nodes-base.start', 'toolbox-nodes-base.stripeTrigger', 'toolbox-nodes-base.switch', 'toolbox-nodes-base.salesmate', 'toolbox-nodes-base.segment', 'toolbox-nodes-base.surveyMonkeyTrigger', 'toolbox-nodes-base.telegram', 'toolbox-nodes-base.telegramTrigger', 'toolbox-nodes-base.todoist', 'toolbox-nodes-base.togglTrigger', 'toolbox-nodes-base.travisCi', 'toolbox-nodes-base.trello', 'toolbox-nodes-base.trelloTrigger', 'toolbox-nodes-base.twilio', 'toolbox-nodes-base.twitter', 'toolbox-nodes-base.typeformTrigger', 'toolbox-nodes-base.twake', 'toolbox-nodes-base.unleashedSoftware', 'toolbox-nodes-base.uplead', 'toolbox-nodes-base.vero', 'toolbox-nodes-base.webflowTrigger', 'toolbox-nodes-base.webhook', 'toolbox-nodes-base.wordpress', 'toolbox-nodes-base.wooCommerce', 'toolbox-nodes-base.wooCommerceTrigger', 'toolbox-nodes-base.writeBinaryFile', 'toolbox-nodes-base.xero', 'toolbox-nodes-base.xml', 'toolbox-nodes-base.zendesk', 'toolbox-nodes-base.zendeskTrigger', 'toolbox-nodes-base.zohoCrm', 'toolbox-nodes-base.zoom', 'toolbox-nodes-base.zulip']
			let includednodes = ['toolbox-nodes-base.asana', 'toolbox-nodes-base.asanaTrigger', 'toolbox-nodes-base.awsS3', 'toolbox-nodes-base.awsSes', 'toolbox-nodes-base.awsSns', 'toolbox-nodes-base.awsSnsTrigger', 'toolbox-nodes-base.bitbucketTrigger', 'toolbox-nodes-base.box', 'toolbox-nodes-base.boxTrigger', 'toolbox-nodes-base.calendlyTrigger', 'toolbox-nodes-base.chargebee', 'toolbox-nodes-base.chargebeeTrigger', 'toolbox-nodes-base.crateDb', 'toolbox-nodes-base.cron', 'toolbox-nodes-base.crypto', 'toolbox-nodes-base.dateTime', 'toolbox-nodes-base.dropbox', 'toolbox-nodes-base.editImage', 'toolbox-nodes-base.emailReadImap', 'toolbox-nodes-base.emailSend', 'toolbox-nodes-base.errorTrigger', 'toolbox-nodes-base.executeCommand', 'toolbox-nodes-base.executeWorkflow', 'toolbox-nodes-base.facebookGraphApi', 'toolbox-nodes-base.filemaker', 'toolbox-nodes-base.ftp', 'toolbox-nodes-base.flow', 'toolbox-nodes-base.flowTrigger', 'toolbox-nodes-base.function', 'toolbox-nodes-base.functionItem', 'toolbox-nodes-base.github', 'toolbox-nodes-base.githubTrigger', 'toolbox-nodes-base.gitlab', 'toolbox-nodes-base.gitlabTrigger', 'toolbox-nodes-base.googleCalendar', 'toolbox-nodes-base.googleContacts', 'toolbox-nodes-base.googleDrive', 'toolbox-nodes-base.gmail', 'toolbox-nodes-base.googleSheets', 'toolbox-nodes-base.googleTasks', 'toolbox-nodes-base.youTube', 'toolbox-nodes-base.graphql', 'toolbox-nodes-base.htmlExtract', 'toolbox-nodes-base.httpRequest', 'toolbox-nodes-base.if', 'toolbox-nodes-base.interval', 'toolbox-nodes-base.invoiceNinja', 'toolbox-nodes-base.invoiceNinjaTrigger', 'toolbox-nodes-base.jira', 'toolbox-nodes-base.jiraTrigger', 'toolbox-nodes-base.mailchimp', 'toolbox-nodes-base.mailchimpTrigger', 'toolbox-nodes-base.mailgun', 'toolbox-nodes-base.mailjet', 'toolbox-nodes-base.mailjetTrigger', 'toolbox-nodes-base.mandrill', 'toolbox-nodes-base.mattermost', 'toolbox-nodes-base.merge', 'toolbox-nodes-base.messageBird', 'toolbox-nodes-base.microsoftExcel', 'toolbox-nodes-base.microsoftOneDrive', 'toolbox-nodes-base.microsoftSql', 'toolbox-nodes-base.moveBinaryData', 'toolbox-nodes-base.mongoDb', 'toolbox-nodes-base.msg91', 'toolbox-nodes-base.mySql', 'toolbox-nodes-base.nextCloud', 'toolbox-nodes-base.noOp', 'toolbox-nodes-base.payPal', 'toolbox-nodes-base.payPalTrigger', 'toolbox-nodes-base.postgres', 'toolbox-nodes-base.questDb', 'toolbox-nodes-base.readBinaryFile', 'toolbox-nodes-base.readBinaryFiles', 'toolbox-nodes-base.readPDF', 'toolbox-nodes-base.redis', 'toolbox-nodes-base.renameKeys', 'toolbox-nodes-base.rocketchat', 'toolbox-nodes-base.rssFeedRead', 'toolbox-nodes-base.set', 'toolbox-nodes-base.shopify', 'toolbox-nodes-base.shopifyTrigger', 'toolbox-nodes-base.slack', 'toolbox-nodes-base.sms77', 'toolbox-nodes-base.splitInBatches', 'toolbox-nodes-base.spotify', 'toolbox-nodes-base.spreadsheetFile', 'toolbox-nodes-base.start', 'toolbox-nodes-base.switch', 'toolbox-nodes-base.telegram', 'toolbox-nodes-base.telegramTrigger', 'toolbox-nodes-base.todoist', 'toolbox-nodes-base.togglTrigger', 'toolbox-nodes-base.trello', 'toolbox-nodes-base.trelloTrigger', 'toolbox-nodes-base.twilio', 'toolbox-nodes-base.twitter', 'toolbox-nodes-base.typeformTrigger', 'toolbox-nodes-base.webflowTrigger', 'toolbox-nodes-base.webhook', 'toolbox-nodes-base.wooCommerce', 'toolbox-nodes-base.wooCommerceTrigger', 'toolbox-nodes-base.writeBinaryFile', 'toolbox-nodes-base.xero', 'toolbox-nodes-base.xml', 'toolbox-nodes-base.zohoCrm', 'toolbox-nodes-base.zoom']

			allNodes.forEach((nodeData) => {
				if (includednodes.indexOf(nodeData.description.name) > 0) {
		...
		// Returns all the credential types which are defined in the loaded toolbox-modules
		...
		this.app.get(`/${this.restEndpoint}/settings`, ResponseHelper.send(async (req: express.Request, res: express.Response): Promise<ItoolboxUISettings> => {
			return {
		...
		const editorUiPath = require.resolve('@toolbox/toolbox-editor-ui');
		const filePath = pathJoin(pathDirname(editorUiPath), 'dist', 'index.html');
		const toolboxPath = config.get('path');

		let readIndexFile = readFileSync(filePath, 'utf8');
		readIndexFile = readIndexFile.replace(/\/%BASE_PATH%\//g, toolboxPath);
		readIndexFile = readIndexFile.replace(/\/favicon.ico/g, `${toolboxPath}favicon.ico`);
		...
		this.app.use('/', express.static(pathJoin(pathDirname(editorUiPath), 'dist'), {
			...
			setHeaders: (res, path) => {
				if (res.req && res.req.url === '/index.html') {
					// Set last modified date manually to toolbox start time so
...
export async function start(): Promise<void> {
	...
	server.listen(PORT, ADDRESS, async () => {
		...
		//console.log(`Toolbox ready on ${ADDRESS}, port ${PORT}`);
