...
export async function buildFiles (options?: IBuildOptions): Promise<string> {
	...
	const outputDirectory = options.destinationFolder || UserSettings.getUsertoolboxFolderCustomExtensionPath();

	// Supply a node base path so that it finds @toolbox/toolbox-core and @toolbox/toolbox-workflow
