...
/**
 * Takes a buffer and converts it into the format toolbox uses. It encodes the binary data as
...
/**
 * Takes generic input data and brings it into the json format toolbox uses.
 *
 * @export
