		...
		<div class="side-menu-wrapper" :class="{expanded: !isCollapsed}">
			...
			<el-menu default-active="workflow" @select="handleSelect" :collapse="isCollapsed">
				...
				<el-menu-item index="logo" class="logo-item">
						<a href="" class="logo">
						<img class="icon" src="../assets/circle.png" alt="toolBox"/>
						<span class="logo-text" slot="title">ToolBox</span>
					</a>
				</el-menu-item>
				...
				<!-- <el-submenu index="help" class="help-menu" title="Help"> -->
					...
					<!-- <el-menu-item index="help-documentation"> -->
						<!-- <template slot="title"> -->
							<!-- <a href="https://docs.toolbox.io" target="_blank"> -->
					...
					<!-- <el-menu-item index="help-forum"> -->
						<!-- <template slot="title"> -->
							<!-- <a href="https://community.toolbox.io" target="_blank"> -->
					...
					<!-- <el-menu-item index="help-examples"> -->
						<!-- <template slot="title"> -->
							<!-- <a href="https://toolbox.io/workflows" target="_blank"> -->
								<!-- <font-awesome-icon icon="network-wired"/> -->
					...
					<!-- <el-menu-item index="help-about"> -->
						<!-- <template slot="title"> -->
							...
							<!-- <span slot="title" class="item-title">About toolbox</span> -->
						<!-- </template> -->
					<!-- </el-menu-item> -->
				<!-- </el-submenu> -->
